...
var AuthMiddleware = /** @class */ (function () {
    function AuthMiddleware() {
        var _this = this;
        this.jwt = new JwtModule_1.default();
        this.TOKEN_EXPIRED = -3;
        this.TOKEN_INVALID = -2;
        this.userRepo = typeorm_1.getRepository(User_1.User);
        this.checkToken = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var cookies, token, decodedToken, id, userInfo, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        id = decodedToken.id;
                        return [4 /*yield*/, this.userRepo.findOneOrFail({ where: { id: id } })];
                    case 2:
                        userInfo = _a.sent();
                        req.user = userInfo;
                    ...
                    case 5: return [2 /*return*/, next(new AuthenticationTokenMissingException_1.default())];
